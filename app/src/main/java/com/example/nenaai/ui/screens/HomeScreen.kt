...
fun HomeScreen(
    ...
    Box(
        ...
        Column(
            ...
            if (verificationStatus in listOf("UNVERIFIED_OTP", "OTP_VERIFIED", "PROFILE_COMPLETE")) {
                Card(
                    modifier = Modifier
                        .fillMaxWidth()
            ...
            } else if (verificationStatus == "DOCUMENTS_PENDING") {
                // NEW card for documents pending
                Card(
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(horizontal = 16.dp),
